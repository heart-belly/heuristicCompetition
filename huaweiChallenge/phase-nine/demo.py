...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='pascal',
                        choices=['pascal', 'coco', 'cityscapes','invoice', 'voc'],
                        help='dataset name (default: voc)')
    ...
    pretrained_dict = ckpt['state_dict']  # 假设ckpt是一个字典，包含'state_dict'键
    # 移除'module.'前缀
